# dictabert_large — All Experiment Scripts

**Model:** `dicta-il/dictabert-large`  
**Script:** `src.models.train_student`  
**Batch:** 8 | **Mem:** 32G | **Time:** 10:00:00
...
- **A4**: Compare `dictabert_large/P2_add_focal` vs `dictabert_crf/P2_crf_weighted` — CRF on/off
